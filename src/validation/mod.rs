...
pub use accuracy::{
    calculate_ari, calculate_embedding_accuracy, calculate_exact_match_ratio,
    calculate_full_accuracy, calculate_matrix_accuracy, calculate_metadata_accuracy, calculate_mse,
    calculate_nmi, calculate_sparsity, pearson_correlation, AccuracyMetrics, AccuracyReport,
    EmbeddingAccuracy, MetadataAccuracy,
};
pub use cross_format::{
    compare_h5ad_rds, compare_h5ad_rds_default, compare_ir_cross_format, validate_h5ad_to_rds,
    validate_h5ad_to_rds_default, validate_rds_to_h5ad, validate_rds_to_h5ad_default,
    validate_roundtrip, validate_roundtrip_default, ConversionDirection, CrossFormatReport,
    CrossFormatValidationResult, RoundtripValidationResult, DEFAULT_TOLERANCE,
};
pub use dimensions::{
    dimension_report, validate_dimensions, validate_expression_matrix_dimensions,
};
pub use schema::{
...
impl ValidationReport {
    ...
    pub fn summary(&self) -> String {
        ...
        let mut summary = format!("Validation Summary: {}/{} components passed", passed, total);
